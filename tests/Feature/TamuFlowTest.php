...
class TamuFlowTest extends TestCase
{
    ...
    public function test_operator_account_can_store_visit_and_remains_authenticated(): void
    {
        Storage::fake('local');
    ...
    public function test_public_user_cannot_access_records_or_photos(): void
    {
